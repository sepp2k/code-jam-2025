...
def h1(*children: Element | str, **attributes: dict[str, str]) -> Element:
    """Create an top level heading."""
    return _tag("h1", *children, **attributes)


def h2(*children: Element | str, **attributes: dict[str, str]) -> Element:
    """Create a second level heading."""
    return _tag("h2", *children, **attributes)


def div(*children: Element | str, **attributes: dict[str, str]) -> Element:
    """Create a div element."""
    return _tag("div", *children, **attributes)


def p(*children: Element | str, **attributes: dict[str, str]) -> Element:
    """Create a paragraph."""
...
def em(*children: Element | str, **attributes: dict[str, str]) -> Element:
    """Create an em element."""
    return _tag("em", *children, **attributes)


def textarea(*children: Element | str, **attributes: dict[str, str]) -> Element:
    """Create a text area."""
    return _tag("textarea", *children, **attributes)


def button(*children: Element | str, **attributes: dict[str, str]) -> Element:
    """Create a button."""
